    ...
    <div>
      <div className=' flex flex-col gap-4 m-5'>
        ...
        <div className=' flex-1 border border-stone-100 rounded-lg p-8 py-7 bg-white'>
          ...
          {/* doc about  */}
          <div>
            <p className=' flex items-center gap-1 text-sm mt-3 font-medium text-neutral-800'>About:</p>
            <p className=' text-sm mt-1 text-gray-600 max-w-[700px] '>{profileData.about}</p>
          </div>
